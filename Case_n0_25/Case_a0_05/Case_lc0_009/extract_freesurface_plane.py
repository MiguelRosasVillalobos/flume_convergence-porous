...
case_lc0_009foam = OpenFOAMReader(registrationName='Case_lc0_009.foam', FileName='/home/miguel/flume_convergence_porous/Case_n0_25/Case_a0_05/Case_lc0_009/Case_lc0_009.foam')

# Properties modified on case_5foam
case_lc0_009foam.SkipZeroTime = 0
case_lc0_009foam.CaseType = 'Decomposed Case'

# get active view
renderView1 = GetActiveViewOrCreate('RenderView')

# show data in view
case_lc0_009foamDisplay = Show(case_lc0_009foam, renderView1, 'UnstructuredGridRepresentation')

# trace defaults for the display properties.
case_lc0_009foamDisplay.Representation = 'Surface'
...
# create a new 'Slice'
slice1 = Slice(registrationName='Slice1', Input=case_lc0_009foam)

# set active source
SetActiveSource(case_lc0_009foam)

# create a new 'Slice'
slice1_1 = Slice(registrationName='Slice1', Input=case_lc0_009foam)

# Properties modified on case_5foam
case_lc0_009foam.MeshRegions = ['internalMesh']
case_lc0_009foam.CellArrays = ['U', 'alpha.water', 'p', 'p_rgh', 'porosity']
...
# hide data in view
Hide(case_lc0_009foam, renderView1)
...
# save data
SaveData('/home/miguel/flume_convergence_porous/Case_n0_25/Case_a0_05/Case_lc0_009/data$p.csv', proxy=contour1, WriteTimeSteps=1,
