...
case_lc0_02foam = OpenFOAMReader(registrationName='Case_lc0_02.foam', FileName='/home/miguel/flume_convergence_porous/Case_n0_25/Case_a0_05/Case_lc0_02/Case_lc0_02.foam')

# Properties modified on case_5foam
case_lc0_02foam.SkipZeroTime = 0
case_lc0_02foam.CaseType = 'Decomposed Case'

# get active view
renderView1 = GetActiveViewOrCreate('RenderView')

# show data in view
case_lc0_02foamDisplay = Show(case_lc0_02foam, renderView1, 'UnstructuredGridRepresentation')

# trace defaults for the display properties.
case_lc0_02foamDisplay.Representation = 'Surface'
...
# create a new 'Slice'
slice1 = Slice(registrationName='Slice1', Input=case_lc0_02foam)

# set active source
SetActiveSource(case_lc0_02foam)

# create a new 'Slice'
slice1_1 = Slice(registrationName='Slice1', Input=case_lc0_02foam)

# Properties modified on case_5foam
case_lc0_02foam.MeshRegions = ['internalMesh']
case_lc0_02foam.CellArrays = ['U', 'alpha.water', 'p', 'p_rgh', 'porosity']
...
# hide data in view
Hide(case_lc0_02foam, renderView1)
...
# save data
SaveData('/home/miguel/flume_convergence_porous/Case_n0_25/Case_a0_05/Case_lc0_02/data$p.csv', proxy=contour1, WriteTimeSteps=1,
