...
case_lc0_025foam = OpenFOAMReader(registrationName='Case_lc0_025.foam', FileName='/home/miguel/flume_convergence_porous/Case_n0_5/Case_a0_436/Case_lc0_025/Case_lc0_025.foam')

# Properties modified on case_5foam
case_lc0_025foam.SkipZeroTime = 0
case_lc0_025foam.CaseType = 'Decomposed Case'

# get active view
renderView1 = GetActiveViewOrCreate('RenderView')

# show data in view
case_lc0_025foamDisplay = Show(case_lc0_025foam, renderView1, 'UnstructuredGridRepresentation')

# trace defaults for the display properties.
case_lc0_025foamDisplay.Representation = 'Surface'
...
# create a new 'Slice'
slice1 = Slice(registrationName='Slice1', Input=case_lc0_025foam)

# set active source
SetActiveSource(case_lc0_025foam)

# create a new 'Slice'
slice1_1 = Slice(registrationName='Slice1', Input=case_lc0_025foam)

# Properties modified on case_5foam
case_lc0_025foam.MeshRegions = ['internalMesh']
case_lc0_025foam.CellArrays = ['U', 'alpha.water', 'p', 'p_rgh', 'porosity']
...
# hide data in view
Hide(case_lc0_025foam, renderView1)
...
# save data
SaveData('/home/miguel/flume_convergence_porous/Case_n0_5/Case_a0_436/Case_lc0_025/data$p.csv', proxy=contour1, WriteTimeSteps=1,
